...
class DatabaseCreation(BaseDatabaseCreation):
    ...
    def _create_test_db(self, verbosity=1, autoclobber=False):
        ...
        real_settings['PASSWORD'] = self.connection.settings_dict['PASSWORD'] = self.connection.settings_dict['SAVED_PASSWORD']
    ...
    def _destroy_test_db(self, test_database_name, verbosity=1):
        ...
        if self._test_user_create():
            ...
            #TODO: Openedge delete test user : self._destroy_test_user(cursor, parameters, verbosity)
        if self._test_database_create():
            if verbosity >= 1:
                print('Destroying test database tables...')
            #TODO: Openedge delete test database : self._execute_test_db_destruction(cursor, parameters, verbosity)
    ...
    def _test_database_user(self):
        name = self.connection.settings_dict['USER']
        try:
